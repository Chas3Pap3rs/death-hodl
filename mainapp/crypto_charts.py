...
# app = DjangoDash(__name__, external_stylesheets=[dbc.themes.CYBORG], suppress_callback_exceptions=True)
# load_figure_template("vapor") ##https://pypi.org/project/dash-bootstrap-templates/
# app.title = "Crypto Charts"
...
#                     dbc.Col(dbc.NavbarBrand("Crypto Charts", className="ml-2"))
